...
#define BOOST_TREE_NODE_EMPLACEMENT_CTOR_HEADER(r, tuple)                    \
        BOOST_PP_EXPR_IF(                                                    \
...
#define BOOST_TREE_NODE_EMPLACEMENT_CTOR_FWD_DECL(r, tuple)                  \
        BOOST_TREE_NODE_EMPLACEMENT_CTOR_HEADER(r, tuple);                   \
//!

#define BOOST_TREE_NODE_EMPLACEMENT_CTOR_BASE_FWD(r, tuple)                  \
      : BOOST_PP_TUPLE_ELEM(2, 1, tuple)(                                    \
            BOOST_PP_ENUM_PARAMS(                                            \
                BOOST_PP_SEQ_SIZE(BOOST_PP_TUPLE_ELEM(2, 0, tuple))          \
              , p                                                            \
...
#define BOOST_TREE_NODE_EMPLACEMENT_CTOR_INLINE_HEADER(r, tuple)             \
        ...
        BOOST_TREE_NODE_EMPLACEMENT_CTOR_BASE_FWD(                           \
          ...
          , (                                                                \
                BOOST_PP_TUPLE_ELEM(2, 0, tuple)                             \
              , BOOST_PP_TUPLE_ELEM(2, 1, BOOST_PP_TUPLE_ELEM(2, 1, tuple))  \
            )                                                                \
        )                                                                    \
//!

#define BOOST_TREE_NODE_EMPLACEMENT_CTOR_INLINE_DEF(r, tuple)                \
...
#define BOOST_TREE_NODE_EMPLACEMENT_CTOR_W_ALLOC_HEADER(r, tuple)            \
        BOOST_PP_EXPR_IF(                                                    \
            BOOST_PP_SEQ_SIZE(BOOST_PP_TUPLE_ELEM(2, 0, tuple))              \
          , template <                                                       \
        ) BOOST_PP_ENUM_PARAMS(                                              \
...
#define BOOST_TREE_NODE_EMPLACEMENT_CTOR_W_ALLOC_FWD_DECL(r, tuple)          \
        BOOST_TREE_NODE_EMPLACEMENT_CTOR_W_ALLOC_HEADER(r, tuple);           \
//!

#define BOOST_TREE_NODE_EMPLACEMENT_CTOR_W_ALLOC_BASE_FWD(r, tuple)          \
      : BOOST_PP_TUPLE_ELEM(2, 1, tuple)(                                    \
...
#define BOOST_TREE_NODE_EMPLACEMENT_CTOR_W_ALLOC_INLINE_HEADER(r, tuple)     \
...
#define BOOST_TREE_NODE_EMPLACEMENT_CTOR_W_ALLOC_INLINE_DEF(r, tuple)        \
...
#define BOOST_TREE_NODE_EMPLACEMENT_CTOR_HEADER(z, n, Type)                  \
        ...
        BOOST_PP_EXPR_IF(n, >)                                               \
        BOOST_PP_EXPR_IIF(BOOST_PP_EQUAL(1, n), explicit)                    \
        Type(                                                                \
