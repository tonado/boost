...
void output_node_test(Node const& node, char const* str)
{
    std::cout << std::endl << "        BOOST_CHECK(" << (
        get(node, boost::tree_node::data_key()).numerator()
    ) << " == get(" << str << ", boost::tree_node::data_key()).numerator());";
    std::cout << std::endl << "        BOOST_CHECK(" << (
        get(node, boost::tree_node::height_key())
    ) << " == get(" << str << ", boost::tree_node::height_key()));";
    std::cout << std::endl << "        BOOST_CHECK(" << (
        get(node, boost::tree_node::count_key())
    ) << " == get(" << str << ", boost::tree_node::count_key()));";
}

template <typename Node>
void output_node_test_long(Node const& node, char const* str)
{
    std::cout << std::endl << "        BOOST_CHECK(" << std::endl;
    std::cout << "            " << (
        get(node, boost::tree_node::data_key()).numerator()
    ) << " == get(" << std::endl << "                " << str << std::endl;
    ...
    std::cout << "              , boost::tree_node::height_key()" << std::endl;
    std::cout << "            )" << std::endl << "        );" << std::endl;
    std::cout << "        BOOST_CHECK(" << std::endl << "            ";
    std::cout << get(node, boost::tree_node::count_key()) << " == get(";
    std::cout << std::endl << "                " << str << std::endl;
    std::cout << "              , boost::tree_node::count_key()" << std::endl;
    std::cout << "            )" << std::endl << "        );";
}
...
#if defined BOOST_TREE_NODE_CAN_USE_FUSION
template <typename Node>
void output_full_node_test(Node const& node, char const* str)
{
    output_node_test(node, str);
    std::cout << std::endl << "#if defined BOOST_TREE_NODE_CAN_USE_FUSION";
    std::cout << std::endl << "        BOOST_CHECK(" << std::endl;
    std::cout << "            " << boost::tree_node::get<
    ...
    std::cout << "            ).numerator()" << std::endl << "        );";
    std::cout << std::endl << "        BOOST_CHECK(" << (
        get(node, AccuHeightKey())
    ) << " == get(" << str << ", AccuHeightKey()));";
    std::cout << std::endl << "        BOOST_CHECK(" << (
        get(node, AccuCountKey())
    ) << " == get(" << str << ", AccuCountKey()));";
    std::cout << std::endl << "        BOOST_CHECK(" << (
        get(node, AccuAccuKey()).numerator()
    ) << " == get(" << str << ", AccuAccuKey()).numerator());";
    std::cout << std::endl << "        BOOST_CHECK(" << (
        get(node, AccuAccuKey()).denominator()
    ) << " == get(" << str << ", AccuAccuKey()).denominator());";
    std::cout << std::endl << (
...
template <typename Node>
void output_full_node_test_long(Node const& node, char const* str)
{
    output_node_test_long(node, str);
    std::cout << std::endl << "#if defined BOOST_TREE_NODE_CAN_USE_FUSION";
    std::cout << std::endl << "        BOOST_CHECK(" << std::endl;
    std::cout << "            " << boost::tree_node::get<
        boost::tree_node::accumulation_key<>
    ...
    std::cout << "            ).numerator()" << std::endl << "        );";
    std::cout << std::endl << "        BOOST_CHECK(" << std::endl;
    std::cout << "            " << get(node, AccuHeightKey()) << " == get(";
    std::cout << std::endl << "                " << str << std::endl;
    std::cout << "              , AccuHeightKey()" << std::endl;
    std::cout << "            )" << std::endl << "        );" << std::endl;
    std::cout << "        BOOST_CHECK(" << std::endl << "            ";
    std::cout << get(node, AccuCountKey()) << " == get(" << std::endl;
    std::cout << "                " << str << std::endl;
    std::cout << "              , AccuCountKey()" << std::endl;
    std::cout << "            )" << std::endl << "        );" << std::endl;
    std::cout << "        BOOST_CHECK(" << std::endl << "            ";
    std::cout << get(node, AccuAccuKey()).numerator() << " == get(";
    std::cout << std::endl << "                " << str << std::endl;
    std::cout << "              , AccuAccuKey()" << std::endl;
    std::cout << "            ).numerator()" << std::endl << "        );";
    std::cout << std::endl << "        BOOST_CHECK(" << std::endl;
    std::cout << "            " << get(node, AccuAccuKey()).denominator();
    std::cout << " == get(" << std::endl << "                " << str;
    std::cout << std::endl << "              , AccuAccuKey()" << std::endl;
...
{
    std::cout << get(node, example_keys::row_number());
    std::cout << (b ? ", " : ",");
...
#endif  // defined BOOST_TREE_NODE_CAN_USE_FUSION_WITH_TYPEOF

#endif  // defined BOOST_TYPEOF_COMPLIANT
